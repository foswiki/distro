...
$.fn.fluidfont=$.fluidfont.build;$(function(){$(".jqFluidFont").not(".jqInited").each(function(){var $this=$(this);var opts=$.extend({},$this.metadata());$this.addClass("jqInited");$this.fluidfont(opts);});});})(jQuery);;
