jQuery(function($){$(".jqTreeview:not(.jqInitedTreeview)").livequery(function(){var $this=$(this);$this.addClass("jqInitedTreeview");var parentClass=$this.attr('class');$this.find("> ul").each(function(){var args=Array();if(parentClass.match(/\bopen\b/)){args['collapsed']=false;}
...
$(this).treeview(args);});$this.css('display','block');});});;
