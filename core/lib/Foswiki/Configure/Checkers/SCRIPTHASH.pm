...
package Foswiki::Configure::Checkers::SCRIPTHASH;

# Specialised checker for SCRIPTHASH - added in Pluggables/SCRIPTHASH.pm
# DO NOT USE in .spec files!
