...
#EmptyJQueryPlugin/data/System/JQueryYour.txt
    ...
    writeFile( "$def{MODULE}/pub/System/$def{MODULE}/$def{JQUERYPLUGINMODULELC}", "jquery.$def{JQUERYPLUGINMODULELC}.js", '//replace this with the jquery plugins javascript, and its other files go in this dir.' );
...
#TODO: why aren't we using a list generated by writeFile?
