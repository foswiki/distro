...
# gets expanded to <code>YYYYMM</code> e.g. <code>200501</code>) in the 
# pathnames to cause the file to be renewed every month e.g.
# <code>/var/log/Foswiki/log.%DATE%</code>.</p>
