...
plugins : "table,searchreplace,autosave,paste,safari,inlinepopups,foswikibuttons,foswikiimage%IF{ "context TinyMCEUsabilityUpgradePluginEnabled" then=",foswikilink" else=""}%",
