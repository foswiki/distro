...
sub check {
    ...
    # Check for Foswiki::Func::addToZone in case it exists in core,
    # otherwise check that ZonePlugin is Enabled.
        if ( (not exists &Foswiki::Func::addToZone) and 
            (!$Foswiki::cfg{Plugins}{ZonePlugin}{Enabled}) ) {
