...
sub testSimple {
    ...
    Foswiki::Contrib::MailerContrib::mailNotify( \@webs, $this->{twiki}, 0, undef, 1, 0 );
...
sub testSubweb {
    ...
    Foswiki::Contrib::MailerContrib::mailNotify( \@webs, $this->{twiki}, 0, undef, 0, 0 );
