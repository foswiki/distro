...
\+<nop>$this->{test_web}.RevIt 3
-<nop>%<nop><nop>META:<nop>TOPICINFO{author="<nop>BaseUserMapping_666" comment="" date="[0-9]{7}\.\.\.
\+<nop>%<nop><nop>META:<nop>TOPICINFO{author="<nop>BaseUserMapping_666" comment="" date="[0-9]{7}\.\.\.
 Line 1/ms;
    ...
    $expected = qr# Line 3<br /><del>$this->{test_web}.RevIt 2</del><br /><ins>$this->{test_web}.RevIt 3</ins><br /><del>%META:TOPICINFO{author="BaseUserMapping_666" comment="" date="[0-9]{10}" format="1.1" version="2"}%</del><br /><ins>%META:TOPICINFO{author="BaseUserMapping_666" comment="" date="[0-9]{10}" format="1.1" version="3"}%</ins><br /> Line 1#;
