...
sub _Instantiate_Share {
    ...
    my $share = new IPC::ShareLite(%ipc_options)
      or throw Error::Simple("Couldn't instantiate IPC::ShareLite: $!");
...
sub _Restore_Shared_Hash_Ref {
    ...
    my $frozen_hash_ref = _Instantiate_Share($p_ipc_identifier)->fetch()
      or return {};
...
sub _Restore_Shared_Hash_Ref_With_Lock {
    ...
    my $frozen_hash_ref = $share->fetch()
      or return {};
