...
plugins : "table,searchreplace,autosave,paste,safari,inlinepopups,fullscreen,wordcount,foswikibuttons,foswikiimage%IF{ "context TinyMCEUsabilityUpgradePluginEnabled" then=",foswikilink" else=""}%",
