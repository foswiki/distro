...
$(function(){$("head meta[name^='foswiki.']").each(function(){var val=this.content;if(val=="false"){val=false;}else if(val=="true"){val=true;}else if(val.match(/^{.*}$/)){val=eval("("+val+")");}else if(val.match(/^function/)){val=eval("("+val+")");}
