var FoswikiImageDialog = {
    ...
    showPreviewImage: function(u, st) {
        ...
        if (!st) tinyMCEPopup.dom.setHTML('prev', '<img id="previewImg" src="' + u + 
'" border="0" onload="FoswikiImageDialog.updateImageData(this);" onerror="FoswikiImageDialog.resetImageData();" />');
        else tinyMCEPopup.dom.setHTML('prev', '<img id="previewImg" src="' + u +
'" border="0" onload="FoswikiImageDialog.updateImageData(this, 1);" />');
    }
};
