...
---+ package Foswiki::Cache::SizeAwareMemoryCache

Implementation of a Foswiki::Cache using Cache::SizeAwareMemoryCache
...
@Foswiki::Cache::SizeAwareMemoryCache::ISA = ( 'Foswiki::Cache' );
...
sub init {
  ...
  unless($this->{handler}) {
    $this->{handler} = new Cache::SizeAwareMemoryCache({
