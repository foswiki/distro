...
---+ package Foswiki::Store::DBIStoreContrib::PostgreSQLWrapHandler
CHANGE　RcsWrapHanlder -> PostgreSQL and VC -> DBI

This class implements the pure methods of the Foswiki::Store::DBIStoreContrib::Handler
...
use Foswiki::Store::DBIStoreContrib::Handler ();
our @ISA = ('Foswiki::Store::DBIStoreContrib::Handler');
