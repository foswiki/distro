...
in this object are:
   ...
   * =canfold= - means that adjacent operators of the same name can be
     folded together i.e. the operands of the second operator can be added
     to the parameter list of the first. This is mainly used for comma lists.
