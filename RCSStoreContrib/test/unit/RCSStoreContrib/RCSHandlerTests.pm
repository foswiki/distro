...
sub verify_RepRev {
    ...
    my $string1 = <<HERE;
%META:TOPICINFO{author="JohnTalintyre" comment="in once" date="" format="1.1" version="1"}%
there was a man
HERE
    ...
    $text =~ s/date="\d+"/date=""/g; # disable time
    ...
    my $string2 = <<HERE;
%META:TOPICINFO{author="NotJohnTalintyre" comment="1st replace" date="" format="1.1" version="1"}%
there was a cat
HERE
    $time = time();
...
"Rev 1 did not return the original text\nExpected:\n ($string2)\n Actual\n ($text)"
    ...
    my $string3 = <<HERE;
%META:TOPICINFO{author="J1" comment="2nd entry" date="" format="1.1" version="1"}%
and now this
HERE
...
"2nd revision should have been modified\nExpected:\n ($string3)\n Actual\n ($text)"
    ...
    my $string4 = <<HERE;
%META:TOPICINFO{author="J2" comment="2nd replace" date="" format="1.1" version="1"}%
then this
HERE
