...
package Foswiki::Configure::Checkers::ConfigureGUI::LogViewer::RecordLimit;
...
our @ISA = qw/Foswiki::Configure::Checkers::NUMBER/;
...
sub check {
    ...
    my $value = $query->request_method eq 'POST'? $query->param($keys) : $this->getCfg($keys);
