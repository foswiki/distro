...
package Foswiki::Configure::FeedbackCheckers::Email::SSLClientKeyPassword;

use strict;
use warnings;

use Foswiki::Configure::FeedbackCheckers::Certificate::KeyPasswordChecker ();
